...
module.exports = async function (page, scenario) {
    ...
    await page.route("**/api/tonnageList/9877755/v3/voyages**", async (route) => {
        console.log("Intercepted API call: /api/tonnageList/9877755/v3/voyages");
        await route.fulfill({
            status: 200,
    ...
    await page.route(
        "**/api/historicaltce/forVoyages/9877755**",
        async (route) => {
            console.log(
                "Intercepted API call: /api/historicaltce/forVoyages/9877755"
            );
            await route.fulfill({
                status: 200,
                contentType: "application/json",
